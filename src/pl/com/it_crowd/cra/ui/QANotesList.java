...
// ------------------------------ FIELDS ------------------------------
    ...
    public static final String FILTER_MISSING_TICKET_NOTES_PROPERTY = "filterMissingTicket";

    public static final String FILTER_NO_TICKET_NOTES_PROPERTY = "filterNoTicket";

    private PropertyChangeSupport changeSupport = new PropertyChangeSupport(this);

    private Action createTicketsAction = new CreateTicketsAction("Create tickets", new ImageIcon(getClass().getResource("/actions/execute.png")));
    ...
    private boolean filterMissingTicketNotes;
    ...
    public List<String> getValidAssignees()
    {
        if (validAssignees == null) {
            try {
                ...
                final List<AssigneeType> assignees = ticketManager.getAssignees();
...
// -------------------------- OTHER METHODS --------------------------
    ...
    public void setFilterMissingTicketNotes(boolean filterMissingTicketNotes)

    {
        boolean oldValue = this.filterMissingTicketNotes;
        this.filterMissingTicketNotes = filterMissingTicketNotes;
        changeSupport.firePropertyChange(FILTER_MISSING_TICKET_NOTES_PROPERTY, oldValue, this.filterMissingTicketNotes);
    }
    ...
    private void createUIComponents()
    {
        ...
        sorter.setRowFilter(new RowFilter<TableModel, Integer>() {
            ...
            {
                final String ticketId = entry.getStringValue(4);
                if (filterNoTicketNotes && !StringUtils.isBlank(ticketId)) {
                    return false;
                }
                if (filterMissingTicketNotes && (StringUtils.isBlank(ticketId) || ticketManager.getTicket(ticketId) != null)) {
                    return false;
                }
...
// -------------------------- INNER CLASSES --------------------------
    ...
    private class CreateTicketsAction extends AbstractAction {
// --------------------------- CONSTRUCTORS ---------------------------

        public CreateTicketsAction(String tooltip, Icon icon)
        {
